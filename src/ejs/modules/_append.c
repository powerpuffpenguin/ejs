...
{
    duk_size_t src_len;
    uint8_t *src = duk_require_buffer_data(ctx, 0, &src_len);
    ...
    duk_size_t available = buf_cap - buf_len;
    ...
    duk_pop_2(ctx);
    buf_cap = ppp_c_string_grow_calculate(buf_cap, buf_len, src_len - available);
