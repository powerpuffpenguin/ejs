package("libevent")
    ...
    add_urls("https://github.com/powerpuffpenguin/libevent/archive/refs/tags/$(version)")
    add_urls("https://github.com/powerpuffpenguin/libevent.git")
    ...
    add_configs("mbedtls", {description = "Build with mbedtls library.", default = true, type = "boolean"})
    ...
    on_install("windows", "linux", "macosx", function (package)
        ...
        local configs = {"-DEVENT__DISABLE_TESTS=OFF", "-DEVENT__DISABLE_REGRESS=OFF", "-DEVENT__DISABLE_SAMPLES=OFF"}
