...
function doTest(assert, tests, name, H, hash, blocksize, hashsize) {
    var e_1, _a;
    assert.equal(blocksize, H.blocksize, 'blocksize');
    assert.equal(hashsize, H.hashsize, 'hashsize');
    assert.equal(blocksize, hash.blocksize, "".concat(name, " blocksize"));
    assert.equal(hashsize, hash.hashsize, "".concat(name, " hashsize"));
    ...
    try {
        for (var tests_1 = __values(tests), tests_1_1 = tests_1.next(); !tests_1_1.done; tests_1_1 = tests_1.next()) {
            ...
            assert.equal(t.out, (0, hex_1.encodeToString)(H.sum(t.in)), "sum ".concat(t.in));
            ...
            assert.equal(t.out, (0, hex_1.encodeToString)(hash.sum(t.in)), "".concat(name, " sum ").concat(t.in));
            assert.equal(dst.length, hash.sumTo(dst, t.in), "".concat(name, " sumTo ").concat(t.in));
            assert.equal(t.out, (0, hex_1.encodeToString)(dst), "".concat(name, " sumTo ").concat(t.in));
            assert.equal(t.out, (0, hex_1.encodeToString)(hash.done(t.in)), "".concat(name, " done ").concat(t.in));
            hash.reset();
            assert.equal(dst.length, hash.doneTo(dst, t.in), "".concat(name, " doneTo ").concat(t.in));
            assert.equal(t.out, (0, hex_1.encodeToString)(dst), "".concat(name, " doneTo ").concat(t.in));
            hash.reset();
            var b = new TextEncoder().encode(t.in);
            if (b.length > 0) {
                hash.write(b.subarray(0, 1));
                var data = b.subarray(1);
                assert.equal(t.out, (0, hex_1.encodeToString)(hash.sum(data)), "".concat(name, " write.sum ").concat(t.in));
                assert.equal(dst.length, hash.sumTo(dst, data), "".concat(name, " write.sumTo ").concat(t.in));
                assert.equal(t.out, (0, hex_1.encodeToString)(dst), "".concat(name, " write.sumTo ").concat(t.in));
                var h = hash.clone();
                assert.equal(t.out, (0, hex_1.encodeToString)(h.done(data)), "".concat(name, " write.done ").concat(t.in));
                assert.equal(dst.length, hash.doneTo(dst, data), "".concat(name, " write.doneTo ").concat(t.in));
                assert.equal(t.out, (0, hex_1.encodeToString)(dst), "".concat(name, " write.doneTo ").concat(t.in));
                hash.reset();
            }
        }
    }
...
m.test("MD5", function (assert) {
    ...
    doTest(assert, tests, 'md5', hash_1.MD5, new hash_1.MD5(), 64, 16);
});
m.test("SHA1", function (assert) {
    var tests = [
    ...
    doTest(assert, tests, 'sha1', hash_1.SHA1, new hash_1.SHA1(), 64, 20);
});
m.test("SHA256", function (assert) {
    var tests = [
    ...
    doTest(assert, tests, 'sha256', hash_1.SHA256, new hash_1.SHA256(), 64, 32);
});
m.test("SHA256_224", function (assert) {
    var tests = [
    ...
    doTest(assert, tests, 'sha256_224', hash_1.SHA256_224, new hash_1.SHA256_224(), 64, 28);
});
m.test("SHA512", function (assert) {
    var tests = [
    ...
    doTest(assert, tests, 'sha512', hash_1.SHA512, new hash_1.SHA512(), 128, 64);
});
m.test("SHA512_384", function (assert) {
    var tests = [
    ...
    doTest(assert, tests, 'sha512_384', hash_1.SHA512_384, new hash_1.SHA512_384(), 128, 48);
});
m.test("SHA512_256", function (assert) {
    var tests = [
    ...
    doTest(assert, tests, 'sha512_256', hash_1.SHA512_256, new hash_1.SHA512_256(), 128, 32);
});
m.test("SHA512_224", function (assert) {
    var tests = [
    ...
    doTest(assert, tests, 'sha512_224', hash_1.SHA512_224, new hash_1.SHA512_224(), 128, 28);
});
m.test("SHA3_512", function (assert) {
    var tests = [
    ...
    doTest(assert, tests, 'sha3_512', hash_1.SHA3_512, new hash_1.SHA3_512(), 72, 64);
});
m.test("SHA3_384", function (assert) {
    var tests = [
    ...
    doTest(assert, tests, 'sha3_384', hash_1.SHA3_384, new hash_1.SHA3_384(), 104, 48);
});
m.test("SHA3_256", function (assert) {
    var tests = [
    ...
    doTest(assert, tests, 'sha3_256', hash_1.SHA3_256, new hash_1.SHA3_256(), 136, 32);
});
m.test("SHA3_224", function (assert) {
    var tests = [
    ...
    doTest(assert, tests, 'sha3_224', hash_1.SHA3_224, new hash_1.SHA3_224(), 144, 28);
});
