...
declare module "ejs/encoding/hex" {
     ...
     */
    export function encodedLen(data: Uint8Array): number
    export function encodedLen(n: number | string | Uint8Array): number
     ...
     */
    export function decodedLen(decoded: Uint8Array): number
    export function decodedLen(n: number | string | Uint8Array): number
     ...
     */
    export function decode(src: string | Uint8Array): Uint8Array
